...
Original file is located at
    https://colab.research.google.com/drive/1tgSVLZ8DFOqblMr1DKCCDK7mn0NzrSuo
"""
...
Hyderabad = India_Districts.filter(ee.Filter.eq('District','HYDERABAD')) #Filtering Hyderabad from Telangana , visualizing my study area
...
m.addLayer(landsat7_fcc_2000,{},'FCC_2000')
m.addLayer(landsat7_tcc_2000,{},'TCC_2000') #adding TCC and FCC datasets of Landsat 7 for the year of 2000
m
...
m.addLayer(landsat9_fcc_2024,{},'FCC_2024')
m.addLayer(landsat9_tcc_2024,{},'TCC_2024') #adding TCC and FCC datasets of Landsat 9 for the year of 2024
m

sentinel_data_2015=ee.ImageCollection("COPERNICUS/S2_HARMONIZED").filterDate('2015-07-01', '2015-12-31')
sentinel_data_2024=ee.ImageCollection("COPERNICUS/S2_HARMONIZED").filterDate('2024-01-01', '2024-12-31')

sentinel_2015_tcc=sentinel_data_2015.select('B4','B3','B2').mean().clip(Hyderabad)  
sentinel_2015_fcc=sentinel_data_2015.select('B8','B4','B3').mean().clip(Hyderabad)
...
m.addLayer(sentinel_2015_tcc,{},'TCC_2015')
m.addLayer(sentinel_2015_fcc,{},'FCC_2015')
m.addLayer(sentinel_2024_tcc,{},'TCC_2024')
m.addLayer(sentinel_2024_fcc,{},'FCC_2024')
m

#Visualizing Railways and Landuse clipped within Hyderabad Boundaries. 
